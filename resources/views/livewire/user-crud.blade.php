...
<div class="bg-white p-6 rounded-lg shadow-md">
    ...
    {{-- <div id="modalAEdit tabindex="-1" aria-hidden="true" class="hidden overflow-y-auto overflow-x-hidden fixed top-0 right-0 left-0 z-50 justify-center items-center w-full md:inset-0 h-[calc(100%-1rem)] max-h-full">
                ...
                @foreach($users as $user)
                    <tr>
                        ...
                        <td class="px-6 py-4 whitespace-nowrap">
                            <button  data-modal-target="modalEdit" data-modal-toggle="modalEdit" class="text-indigo-600 hover:text-indigo-900">Edit</button>
                            <button onclick="openDeleteModal({{ $user }})" class="text-red-600 hover:text-red-900">Delete</button>
                        </td>
                       <div id="modalEdit" tabindex="-1" aria-hidden="true" class="hidden overflow-y-auto overflow-x-hidden fixed top-0 right-0 left-0 z-50 justify-center items-center w-full md:inset-0 h-[calc(100%-1rem)] max-h-full">
                            <div class="relative p-4 w-full max-w-md max-h-full">
                                ...
                                <div class="relative bg-white rounded-lg p-4 shadow dark:bg-gray-700">
                                    ...
                                    <!-- Modal body -->
                                    <form id="userForm" method="PUT" action="{{ route('users.update', $user->id) }}" class="p-4 md:p-5">
                                        @csrf
                                        @method('PUT')
                                        <div class="grid gap-4 mb-4 grid-cols-2">
                                            <div class="col-span-2">
